...
public class UnitsFacade extends AbstractFacade<Units> {
    ...
    public List<Units> getUnitsByUnitNameOrInsName(String str){
        return em.createNamedQuery("Units.findByUnitOrInstituteName").setParameter("unitName", "%" + str.toLowerCase().trim() + "%").getResultList();
    }
